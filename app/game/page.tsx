...
import GameFilters from "@/app/game/components/GameFilters";
import GameTable from "@/app/game/components/GameTable";
...
export default function Page() {
    return <div>
        ...
        <div className="flex gap-2 w-[1374px] h-[44px] items-center pl-[30px] ml-[34px]">
            ...
            <h4 className="w-[42px] h-[18px] text-white font-medium mb-1">O'yinlar</h4>
        </div>
