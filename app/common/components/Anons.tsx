...
export default function Anons() {
    return <div className="w-[326px] h-[192px] flex flex-col items-start relative p-4 bg-[#0B4789] overflow-hidden rounded-[8px]">
        ...
        <h1 className="font-poppins font-[700] text-[20px] w-[294px] mt-2">Aynan <span className="text-[#ffff00]">siz</span> uchun qanday imtiyozlar borligini <br/> bilib oling</h1>
